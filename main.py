...
# app
bot_token = os.environ.get("5623338264:AAG55lQ4QAtwuREWm3hvjN0Ulh2hPwyTNLk", "") 
api_hash = os.environ.get("f4815b9a16cb03c2f5eabe8db1cb0903", "") 
api_id = os.environ.get("18990697", "")
app = Client("my_bot",api_id=api_id, api_hash=api_hash,bot_token=bot_token)


# optionals
auth = os.environ.get("5261482689 1195351595", "")
...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    app.send_message(message.chat.id, '**Hi, I am Mdisk Video Downloader, you can watch Videos without MX Player I will send you as Videos Send Me Any Link...__**',reply_to_message_id=message.id,
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("📦 Source Code Join To Use Bot ", url="https://t.me/+lIitfml8xtAwMDg1")]]))
